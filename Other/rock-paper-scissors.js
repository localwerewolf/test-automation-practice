...
//function to determine the winner of the game based on the above 2 results
...
//function that gets both choice and compares them, then uses the determineWinner function to report the winner
const playGame = () => {
